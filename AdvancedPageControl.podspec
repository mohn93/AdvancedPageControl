...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AdvancedPageControl.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mohanned Binmiskeen/AdvancedPageControl'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mohanned Binmiskeen' => 'mohn93@gmail.com' }
  s.source           = { :git => 'https://github.com/Mohanned Binmiskeen/AdvancedPageControl.git', :tag => s.version.to_s }
